          ...
          <form className="mt-4 grid grid-cols-1 gap-4 md:grid-cols-2" onSubmit={handleCreate}>
            ...
            <div className="md:col-span-2">
              <button
                ...
                className="rounded-xl border border-white/20 bg-white/[0.06] px-4 py-2 text-xs font-semibold uppercase tracking-[0.16em] text-stone-100 transition hover:border-white/35 hover:bg-white/[0.1] disabled:cursor-not-allowed disabled:opacity-60"
              >
