    ...
    <div className={`fixed top-3 z-40 flex items-center gap-2 ${className}`}>
      <div ref={ref}>
        <button
          ...
          aria-expanded={open}
          className="flex items-center gap-3 rounded-2xl border border-white/20 bg-[linear-gradient(180deg,rgba(17,24,39,0.88),rgba(12,18,30,0.92))] px-3.5 py-2.5 shadow-[0_14px_34px_rgba(0,0,0,0.45)] backdrop-blur-xl transition hover:border-cyan-200/40"
        >
          <span className="rounded-lg border border-cyan-200/30 bg-cyan-300/10 px-2 py-0.5 text-[10px] font-semibold uppercase tracking-[0.16em] text-cyan-100">
            Fuxem
          </span>
          {/* hamburger */}
          ...
          <span className="text-xs font-medium uppercase tracking-[0.12em] text-stone-300">{activeLabel}</span>
        </button>

        {open && (
          <div className="absolute left-0 top-full mt-2 w-56 overflow-hidden rounded-2xl border border-white/15 bg-[#0f121a]/95 py-1 shadow-[0_18px_40px_rgba(0,0,0,0.55)] backdrop-blur-xl">
