            ...
            >
              ...
              <div className="relative z-10 space-y-4">
                ...
                <div className="flex items-center justify-between pt-4">
                  ...
                  <svg className="h-5 w-5 text-stone-400 transition group-hover:translate-x-1 group-hover:text-stone-100" fill="none" stroke="currentColor" viewBox="0 0 24 24" aria-hidden="true">
        ...
        <section className="rounded-2xl border border-white/10 bg-black/30 p-6 backdrop-blur-xl sm:p-8">
          ...
          <div className="mt-6 grid gap-4 sm:grid-cols-2">
            <div className="rounded-lg border border-white/10 bg-white/5 p-4">
              <p className="text-xs uppercase tracking-[0.18em] text-stone-400">Coming soon</p>
